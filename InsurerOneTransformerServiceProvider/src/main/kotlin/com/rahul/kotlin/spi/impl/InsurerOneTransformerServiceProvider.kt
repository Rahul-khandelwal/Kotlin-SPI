 ...
 */
class InsurerOneTransformerServiceProvider: TransformerServiceProvider {

    override fun serviceName() : String = "provider-one"
    ...
    override fun toPartnerRequest(uiRequest: JSONObject): JSONObject {
        ...
        return json {
            ...
            "emp_code" To "3954557"
            "quote_type" To "calc"
            "quotation_no" To uiRequest.get("quotation_id")
            "sol_id" To "BANK003"
